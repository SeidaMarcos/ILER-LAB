    ...
    @if($tasks->isEmpty())
        ...
        <div class="card shadow-sm mb-4">
            ...
            <div class="card-body">
                ...
                <div class="text-end">
                    <a href="{{ route('professor.tasks.create') }}" class="d-flex align-items-center justify-content-center btn-create-task"
                        ...
                        <tbody>
                            @foreach ($tasks as $task)
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <!-- Botón Editar -->
                                        <a href="{{ route('professor.tasks.edit', $task->id) }}" class="btn btn-outline-secondary btn-sm">
                                            <i class="fas fa-edit"></i>
                                        </a>
                                        <!-- Botón Eliminar -->
                                        <form action="{{ route('professor.tasks.destroy', $task->id) }}" method="POST" class="d-inline">
                                            @csrf
                                            @method('DELETE')
