...
<head>
    ...
    <title>Dashboard del Profesor - IlerLab</title>
...
<body>
    <div class="container my-5">
            ...
            <ul class="dropdown-menu" aria-labelledby="dropdownMenuLink">
                ...
                <li>
                    <form action="{{ route('logout') }}" method="POST">
                        @csrf
                        <button type="submit" class="dropdown-item"><i class="fas fa-sign-out-alt"></i> Cerrar
                            Sesión</button>
                    </form>
                </li>
            </ul>
        ...
        <!-- Modal para editar los datos del profesor -->
        <div class="modal fade @if ($errors->any()) show @endif" id="editProfileModal" tabindex="-1"
            aria-labelledby="editProfileModalLabel" aria-hidden="true" @if ($errors->any()) style="display: block;"
            @endif>
