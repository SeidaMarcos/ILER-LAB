                                            ...
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body">
                                                    <form action="{{ route('admin.updateUser', $user->id) }}" method="POST">
                                                        ...
                                                        <div class="mb-3">
                                                            <label for="email{{ $user->id }}" class="form-label">Correo
                                                                Electrónico:</label>
                                                            <input type="email" id="email{{ $user->id }}" name="email"
                                                                value="{{ $user->email }}" class="form-control" required>
                                                        </div>
                                                        <div class="mb-3">
                                                            <label for="password{{ $user->id }}" class="form-label">Nueva
                                                                Contraseña
                                                                (opcional):</label>
                                                        ...
                                                        <div class="mb-3">
                                                            ...
                                                            <select id="role{{ $user->id }}" name="role" class="form-select"
                                                                required>
                                                                <option value="2" {{ $user->id_rol == 2 ? 'selected' : '' }}>
                                                                    Profesor</option>
                                                                <option value="3" {{ $user->id_rol == 3 ? 'selected' : '' }}>
                                                                    Estudiante</option>
                                                            </select>
                                                        </div>
                                                        <div class="modal-footer">
