...
<body>
    <div class="container my-5">
        ...
        <!-- Botones de perfil y tareas -->
<div class="d-flex justify-content-between align-items-center mb-4">
    <!-- Menú desplegable de perfil (alineado a la izquierda) -->
    <div class="dropdown">
    ...
    <!-- Botón Tareas (alineado a la derecha) -->
                                            ...
                                            <div class="modal-content">
                                                <div class="modal-header">
                                                    <h5 class="modal-title"
                                                        id="editUserModalLabel{{ $user->id }}">Editar Usuario</h5>
                                                    ...
                                                    <form action="{{ route('admin.updateUser', $user->id) }}" method="POST">
                                                        ...
                                                        <div class="mb-3">
                                                            ...
                                                            <select id="role{{ $user->id }}" name="role"
                                                                ...
                                                                <option value="2"
                                                                    {{ $user->id_rol == 2 ? 'selected' : '' }}>Profesor
                                                                </option>
                                                                <option value="3"
                                                                    {{ $user->id_rol == 3 ? 'selected' : '' }}>Estudiante
                                                                </option>
                                                            </select>
                                                        </div>
                                                        <div class="modal-footer">
