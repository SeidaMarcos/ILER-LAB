...
<head>
    ...
    <title>Admin Dashboard - IlerLab</title>
    ...
    <div class="container my-5">
        ...
        <div class="dropdown text-end mb-4">
            ...
            <ul class="dropdown-menu" aria-labelledby="dropdownMenuLink">
                <li><a class="dropdown-item" href="#" data-bs-toggle="modal" data-bs-target="#editProfileModal"><i class="fas fa-edit"></i> Editar Perfil</a></li>
                <li>
                ...
                @forelse($registrations as $registration)
                    <tr>
                        ...
                        <td>
                            ...
                            <form action="{{ route('admin.registrations.reject', $registration->id) }}" method="POST" class="d-inline">
                                @csrf
                ...
                @foreach($users as $user)
                    @if($user->id_rol != 1)
                        <tr>
                            ...
                            <td>
                                <button class="btn btn-primary btn-sm" data-bs-toggle="modal" data-bs-target="#editUserModal{{ $user->id }}"><i class="fas fa-edit"></i> </button>
                                <form action="{{ route('admin.deleteUser', $user->id) }}" method="POST" class="d-inline" onsubmit="return confirm('¿Estás seguro de que deseas eliminar este usuario?');">
                                    @csrf
                                    @method('DELETE')
