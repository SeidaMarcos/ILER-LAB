    ...
    <ul class="list-group">
        @foreach($products as $product)
            <li class="list-group-item d-flex justify-content-between align-items-center">
                ...
                <span>
                    <button class="btn btn-warning btn-sm" data-bs-toggle="modal" data-bs-target="#editProductModal{{ $product->id }}">Editar</button>
...
<ul class="list-group">
    @foreach($machines as $machine)
        <li class="list-group-item d-flex justify-content-between align-items-center">
            ...
            <span>
                <button class="btn btn-warning btn-sm" data-bs-toggle="modal" data-bs-target="#editMachineModal{{ $machine->id }}">Editar</button>
...
<ul class="list-group">
    @foreach($tools as $tool)
        <li class="list-group-item d-flex justify-content-between align-items-center">
            ...
            <span>
                <button class="btn btn-warning btn-sm" data-bs-toggle="modal" data-bs-target="#editToolModal{{ $tool->id }}">Editar</button>
