                ...
                <div class="row g-3">
                    ...
                    <div class="col-md-3">
                        <input type="number" step="0.01" name="density" class="form-control"
                            placeholder="Densidad (g/ml)" required>
                    </div>
                    <div class="col-md-3">
                ...
                @foreach($products as $product)
                    <li class="list-group-item d-flex justify-content-between align-items-center">
                        ...
                        <span>
                            ...
                            <form action="{{ route('inventory.destroy.product', $product->id) }}" method="POST"
                                class="d-inline">
                                @csrf
                                @method('DELETE')
                                ...
                                <form action="{{ route('inventory.update.product', $product->id) }}" method="POST">
                                    ...
                                    <div class="modal-body">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input type="number" step="0.01" name="density" class="form-control"
                                                value="{{ $product->density }}" required>
                                        </div>
                                        <div class="mb-3">
                ...
                @foreach($machines as $machine)
                    <li class="list-group-item d-flex justify-content-between align-items-center">
                        ...
                        <span>
                            ...
                            <form action="{{ route('inventory.destroy.machine', $machine->id) }}" method="POST"
                                class="d-inline">
                                @csrf
                                @method('DELETE')
                                <button type="submit" class="btn btn-danger btn-sm">
                    ...
                    <div class="modal fade" id="editMachineModal{{ $machine->id }}" tabindex="-1"
                        aria-labelledby="editMachineModalLabel{{ $machine->id }}" aria-hidden="true">
                        <div class="modal-dialog">
                            <div class="modal-content">
                                <form action="{{ route('inventory.update.machine', $machine->id) }}" method="POST">
                                    ...
                                    @method('PUT')
                                    <div class="modal-header" style="background-color: #14b8a6; color: white;">
                                        <h5 class="modal-title" id="editMachineModalLabel{{ $machine->id }}">Editar Máquina
                                        </h5>
                                        <button type="button" class="btn-close" data-bs-dismiss="modal"
                                            aria-label="Close"></button>
                                    </div>
                                    <div class="modal-body">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input type="text" name="reference" class="form-control"
                                                value="{{ $machine->reference }}" required>
                                        </div>
                                        <div class="mb-3">
                                            <label for="location" class="form-label">Ubicación</label>
                                            <input type="text" name="location" class="form-control"
                        ...
                        <div class="modal-dialog">
                            <div class="modal-content">
                                <form action="{{ route('inventory.update.tool', $tool->id) }}" method="POST">
                                    ...
                                    @method('PUT')
                                    <div class="modal-header" style="background-color: #14b8a6; color: white;">
                                        <h5 class="modal-title" id="editToolModalLabel{{ $tool->id }}">Editar Herramienta
                                        </h5>
                                        <button type="button" class="btn-close" data-bs-dismiss="modal"
                                            aria-label="Close"></button>
                                    </div>
                                    <div class="modal-body">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <select name="material" class="form-select" required>
                                                <option value="vidrio" {{ $tool->material === 'vidrio' ? 'selected' : '' }}>
                                                    Vidrio</option>
                                                <option value="madera" {{ $tool->material === 'madera' ? 'selected' : '' }}>
                                                    Madera</option>
